        ...
        <div class="card-body">
            <div class="text-center mb-6">
                <h2 class="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary">
                    Welcome Back</h2>
                <p class="text-base-content/60 mt-2">Sign in to manage your products</p>
            </div>
            ...
            <div class="text-center text-sm">
                Don't have an account? <a href="{{ route('register') }}" class="link link-primary font-medium">Sign
                    up</a>
            </div>
        </div>
    </div>
